...
Note that we use empty nodes to represent the end of a string in the figures as visual marker. An actual trie implmentation could use a simple flag inside the node containing the last letter of a word. 
